...
$c['my_lifestream.twitter'] = $c['lifestream.factory'](new Lifestream\Service\Twitter($c['browser'], 'lyrixx'), 'twitter.lyrixx');
...
$twitter = $c['my_lifestream.twitter'];
echo '<h2><a href="' . $twitter->getService()->getProfileUrl() . '">Twitter</a></h2>';
displayStream($twitter->boot()->getStream(10));
echo '<hr>';
